...
public class armdays   extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.armday);
        ...
        if(user == null){
            Intent goBackIntent = new Intent(armdays.this, loginActivity.class);
        ...
        if(email == null)
            Toast.makeText(armdays.this, "email is null", Toast.LENGTH_SHORT).show();
...
checkIfThereIsData();
        ...
        day1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                day = "day1";
                InsertData();
                Intent intent = new Intent(armdays.this, ArmWork.class);
        ...
        day6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(armdays.this, "Today is Resting Day", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void MakeText(String text){
        Toast.makeText(armdays.this, text, Toast.LENGTH_LONG).show();
    }
    ...
    public void InsertData(){
        ...
        newDocumentReference.update(profile).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(armdays.this,"Error"+e.toString(), Toast.LENGTH_SHORT).show();
            }
        });
